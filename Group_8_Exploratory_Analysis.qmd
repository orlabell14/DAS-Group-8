...
First, we created a new indicator covariate "Obese" according to the original variable "BMIgroup", because it was a categorical response variable with four different levels as we can see. Our aim was to explore the impact of different factors on obesity, so we use 1 and 0 to denote obese people and other type of people respectively.
