...
```{r}
qchisq(df=6, p=0.95)
qchisq(df=25217, p=0.95)

```

The difference in the null and residual deviance is 499 and this is much larger than the 95th percentile of a chi-squared distribution on 6 degrees of freedom which is 12.59. Therefore it is worth including age in the model.
