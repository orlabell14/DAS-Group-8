...
From our model considering the sex variable we see that sex is not a statistically significant predictor of obesity prevalence. On the other hand, we found that age was statistically significant and was worth including in the model. The estimated probabilities by age group suggest that middle-aged people are more likely to be obese than both younger and older people, which is consistent with what initially appeared to be the case in our exploratory analysis.

Furthermore, we also found socio-economic status to be a statistically significant predictor of obesity with people in full-time education least likely to be obese and people that are permanently unable to work most likely to.
