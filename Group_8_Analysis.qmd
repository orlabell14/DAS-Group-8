...
#| echo: false
#| warning: false
#| fig-cap: Time Series Plot of Obese Observations Over Time(left) and Proportion of obesity by age groups(right).
#| label: fig-time
#| fig-align: center
#| fig-width: 4.5
#| fig-height: 3.5
...
p1=ggplot(obesity_by_time,aes(x=Year,y=Obesity_Prevalence))+
  geom_line()+
...
p2=ggplot(data = obese_age.freq, aes(x = obese_age, y = proportion, fill=obese_age)) + geom_col()+
...
#| echo: false
#| warning: false
#| fig-cap: Proportion of Obesity by Sex(left) and Proportion of Obesity by Employment status(right).
#| label: fig-scat1
#| fig-align: center
#| fig-width: 4.5
#| fig-height: 3.5
...
p3=ggplot(data = obese_sex.freq, aes(x = Sex, y = proportion, fill=Sex)) + geom_col()+
...
p4=ggplot(data = obese_employment.freq, aes(x = obese_employment, y = proportion, fill=obese_employment)) + 
  geom_col()+
...
While our exploratory analysis in @sec-EA and formal analysis in @sec-FA provides insight into the effect of age and socio-economic status on obesity, several limitations are observed. The sample size may be considered unbalanced as the population sizes of each level in the categorical variable are not similar.
