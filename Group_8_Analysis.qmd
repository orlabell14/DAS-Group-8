...
#| echo: false
#| warning: false
#| fig-cap: Proportion of obesity by age groups(left) and Proportion of Obesity by Sex(right).
#| label: fig-scat1
#| fig-align: center
#| fig-width: 4.5
#| fig-height: 3.5
...
p1=ggplot(data = obese_age.freq, aes(x = obese_age, y = proportion, fill=obese_age)) + geom_col()+
  labs(x="Age Group",y="Proportion of Obesity",title="Proportion of Obesity by Age Group")
#gender
...
p2=ggplot(data = obese_sex.freq, aes(x = Sex, y = proportion, fill=Sex)) + geom_col()+
